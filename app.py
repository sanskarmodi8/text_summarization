...
def summarize(text):
    ...
    # inp = tokenizer(text, max_length=1024,  truncation=True, 
    #                 padding="max_length", return_tensors="pt")
    # summary = model.generate(input_ids=inp["input_ids"].to(device),
    #                 attention_mask=inp["attention_mask"].to(device), 
    #                 length_penalty=0.8, num_beams=8, max_length=128)
    
    # decoded_summary = tokenizer.decode(summary.tolist(), skip_special_tokens=True, 
